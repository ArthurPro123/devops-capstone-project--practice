...
class AccountControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
			...
			if (getenv('APP_MODE') === 'container') {
				$this->baseUrl = 'https://arthurssl-8080.theiaopenshiftnext-1-labs-prod-theiaopenshift-4-tor01.proxy.cognitiveclass.ai';
			} else {
				$this->baseUrl = 'http://localhost/devops/devops-capstone-project--practice/service_php';
			}
    ...
    public function testGetAllAccounts()
    {
        ...
        $this->assertEquals(200, $result['status']);
				exit;
        $this->assertCount(1 + 1, $result['body']); # The debugging information counts as 1 too.
    }
